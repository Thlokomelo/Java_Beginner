...
Program shows a class named Employee with JavaDoc comments included. (This Java file
also includes a class named Address, which is required for the Employee class to
work.
 */
