...
Programs examines the Gridpane class with its constructors and methods.
...
public class PizzaOrder extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        grid.addRow(0, lblName, txtName);                    //row 0
        grid.addRow(1, lblPhone, txtPhone);                 //row 1
        grid.addRow(2, lblAddress, txtAddress);             //row 2
        grid.addRow(3, paneSize, paneCrust, paneToppings);  //row 3
        grid.add(paneButtons, 2, 4);                        //Column 2 and 4
    ...
    //helper method that assists in the construction of the message string.
