...
This program uses a text field to allow the user to enter the name of a character 
in a play and the name of the actor who will play the role.

The program then displays an alert box indicating who will play the role of the character. If the user
omits either or both fields, an alert box displays to indicate the error.
 */
